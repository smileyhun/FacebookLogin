...
export class FakeBackendInterceptor implements HttpInterceptor {
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
            ...
            return from(new Promise(resolve => {
                ...
                if (!account) {
                    ...
                    account = {
                        ...
                        facebookId: data.id,
                        name: data.name,
                        extraInfo: `This is some extra info about ${data.name} that is saved in the API asd ` + JSON.stringify(data)
                    }
        ...
        function isLoggedIn() {
            ...
            return authHeader ? authHeader.startsWith('Bearer fake-jwt-token') : false;
        }
